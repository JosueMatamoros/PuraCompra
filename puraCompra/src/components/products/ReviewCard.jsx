...
export default function ReviewCard({ stars, date, reviewText, reviewerName, reviewerRole, reviewerImage }) {
  return (
    <figure className="w-full p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
      ...
      <figcaption className="mt-6 flex items-center space-x-3">
        <Avatar rounded size="xs" img={reviewerImage} alt="profile picture" />
        <div className="flex items-center divide-x-2 divide-gray-300 dark:divide-gray-700">
          <cite className="pr-3 font-medium text-gray-900 dark:text-white">{reviewerName}</cite>
